...
// A config holds all the flags that are handled by the push/pull commands.
type config struct {
...
// generateArgs returns a list of arguments that should be supplied to the
// influx command, based on what was passed in by the user.
